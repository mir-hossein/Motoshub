...
class ADMIN_CTRL_Pages extends ADMIN_CTRL_Abstract
{
    ...
    public function manage()
    {
        ...
        $eventForEnglishSupport = new OW_Event('iismultilingualsupport.show.static.page.name.in.multilingual', array('menuItems'=>$mainMenuItems,'entityType'=>'page'));
        ...
        $eventForEnglishSupport = new OW_Event('iismultilingualsupport.show.static.page.name.in.multilingual', array('menuItems'=>$bottomMenuItems,'entityType'=>'page'));
        OW::getEventManager()->trigger($eventForEnglishSupport);
        if(isset($eventForEnglishSupport->getData()['menuItems'])){
        ...
        $eventForEnglishSupport = new OW_Event('iismultilingualsupport.show.static.page.name.in.multilingual', array('menuItems'=>$hiddenMenuItems,'entityType'=>'page'));
        OW::getEventManager()->trigger($eventForEnglishSupport);
        if(isset($eventForEnglishSupport->getData()['menuItems'])){
...
//~
        ...
        $eventForEnglishFieldSupport = new OW_Event('iismultilingualsupport.store.multilingual.data', array('entityId' => $menuItem->getId(),'entityType'=>'page'));
