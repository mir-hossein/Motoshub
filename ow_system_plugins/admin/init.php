...
$router->addRoute(new OW_Route('admin_settings_log', 'admin/settings/log', 'ADMIN_CTRL_Settings', 'log'));
...
$router->addRoute(new OW_Route('admin_core_update_request_manually', 'admin/platform-update-manually', 'ADMIN_CTRL_Storage', 'platformUpdateRequestManually'));
