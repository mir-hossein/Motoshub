...
class BOL_NavigationService
{
    ...
    public function getMenuItems( array $menuItems )
    {
        ...
        foreach ( $menuItems as $value )
        {
            ...
            OW::getEventManager()->trigger(new OW_Event('iismultilingualsupport.show.static.page.name.in.multilingual', array('menuItem'=>$menuItem,'entityId' => $value['id'],'entityType'=>'page')));
