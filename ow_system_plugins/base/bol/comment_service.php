...
final class BOL_CommentService
{
    ...
    public function deleteEntityComments( $entityType, $entityId )
    {
        ...
        if($commentEntity->pluginKey=='iisnews' || $commentEntity->pluginKey=='video' || $commentEntity->pluginKey=='photo' || $commentEntity->pluginKey=='blogs' || $commentEntity->pluginKey=='event') {
