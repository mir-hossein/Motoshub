...
class BOL_AvatarService
{
    ...
    public function cropAvatar( $userId, $path, $coords, $viewSize, array $editionalParams = array() )
    {
        ...
        {
            $toFilePath = OW::getPluginManager()->getPlugin('base')->getPluginFilesDir() . IISSecurityProvider::generateUniqueId(md5( rand(0,9999999999) )) . '.' .UTIL_File::getExtension($path);
    ...
    public function getDefaultAvatarUrl( $size = 1 )
    {
        ...
        {
            case 1:
                return OW::getPluginManager()->getPlugin('base')->getStaticUrl(). 'css/images/' . 'no-avatar.png';
            case 2:
                return OW::getPluginManager()->getPlugin('base')->getStaticUrl(). 'css/images/' . 'no-avatar-big.png';
        }
    ...
    public function setCustomDefaultAvatar( $size, $file )
    {
        ...
        $fileName = $prefix . IISSecurityProvider::generateUniqueId() . '.' . $ext;
    ...
    public function setAvatarChangeSessionKey()
    {
        ...
        if ( !strlen($key) )
        {
            $key = IISSecurityProvider::generateUniqueId();
