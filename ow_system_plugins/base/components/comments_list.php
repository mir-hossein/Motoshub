...
class BASE_CMP_CommentsList extends OW_Component
{
    ...
    protected function processList( $commentList )
    {
        ...
        foreach ( $commentList as $value )
        {
            ...
            $commentlikeEvent= OW::getEventManager()->trigger(new OW_Event('add.newsfeed.comment.like.component',array('value'=>$value,'cmItemArray'=>$cmItemArray,'commentIdList'=>  $this->commentIdList,'entityType'=> $this->params->getEntityType())));
