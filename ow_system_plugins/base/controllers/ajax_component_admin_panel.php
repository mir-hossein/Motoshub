...
class BASE_CTRL_AjaxComponentAdminPanel extends BASE_CTRL_AjaxComponentPanel
{
    ...
    protected function saveSettings( $data )
    {
        ...
        try
        {
            ...
            $eventForEnglishFieldSupport = new OW_Event('iismultilingualsupport.store.multilingual.data.widget.page',
    ...
    protected function getSettingsMarkup( $data )
    {
        ...
        $eventForEnglishFieldSupport = new OW_Event('iismultilingualsupport.create.multilingual.field.widget.page',
