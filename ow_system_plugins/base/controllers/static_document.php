...
class BASE_CTRL_StaticDocument extends OW_ActionController
{
    ...
    public function index( $params )
    {
        ...
        $eventForEnglishFieldSupport = new OW_Event('iismultilingualsupport.show.data.in.multilingual', array('display'=>'Content','pageController' => $this,'entityType'=>'page','entityId'=>$menuItem->getId()));
