...
class BASE_CTRL_UserList extends OW_ActionController
{
    ...
    {
        OW::getEventManager()->trigger(new OW_Event('iissecurityessentials.check.access.users.list'));
