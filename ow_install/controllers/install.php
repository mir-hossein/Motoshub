...
class INSTALL_CTRL_Install extends INSTALL_ActionController
{
    ...
    {
        $success = true;
        IISSecurityProvider::copyInitialUsersAndPluginsFiles(OW_DIR_PLUGINFILES, OW_DIR_USERFILES);
        ...
        if ( OW::getRequest()->isPost() || $doInstall )
        {
            ...
            {
                OW::getStorage()->fileSetContent($configFile, $_POST['configContent'], true);
                sleep(10);
            ...
            {
                INSTALL::getFeedback()->errorMessage('<b>ow_includes/config.php</b> file is incorrect. Update it with details provided below: '.$e->getMessage());
    ...
    private static function sqlImport( $sqlFile )
    {
        ...
        while ( false !== ($line = fgets($fd, 10240)) )
        {
            ...
            try {
                ...
                throw new LogicException('<b>ow_includes/config.php</b> file is incorrect. Update it with details provided below: '.$e->getMessage());
            }
