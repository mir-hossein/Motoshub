...
class OW_View
{
    ...
    public function render()
    {
        ...
        OW::getEventManager()->trigger(new OW_Event(IISEventManager::CHECK_MASTER_PAGE_BLANK_HTML_FOR_UPLOAD_IMAGE_FORM, array('viewRenderer' => $viewRenderer, 'assignedVars' => $this->assignedVars)));
