...
final class OW
{
    ...
    public static function getDbo()
    {
        ...
        {
            $params = array(
                'host' => defined('OW_DB_HOST')?OW_DB_HOST:'',
                'username' => defined('OW_DB_USER')?OW_DB_USER:'',
                'password' => defined('OW_DB_PASSWORD')?OW_DB_PASSWORD:'',
                'dbname' => defined('OW_DB_NAME')?OW_DB_NAME:''
            );
