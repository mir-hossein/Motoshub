...
class Facebook extends BaseFacebook
{
  ...
  protected function setPersistentData($key, $value) {
    ...
    OW_Session::getInstance()->set($session_var_name, $value);
  }
  ...
  protected function getPersistentData($key, $default = false) {
    ...
    return OW_Session::getInstance()->isKeySet($session_var_name) ?
          OW_Session::getInstance()->get($session_var_name) : $default;
  }
  ...
  protected function clearPersistentData($key) {
    ...
    $session_var_name = $this->constructSessionVariableName($key);
    if (OW_Session::getInstance()->isKeySet($session_var_name)) {
        OW_Session::getInstance()->delete($session_var_name);
    }
  }
