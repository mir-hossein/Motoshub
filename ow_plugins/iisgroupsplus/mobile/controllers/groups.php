...
class IISGROUPSPLUS_MCTRL_Groups extends OW_MobileActionController
{
    ...
    public function fileList( $params )
    {
        ...
        foreach ( $dtoList as $item ) {
            ...
            $itemInformation['imageSrc'] = IISGROUPSPLUS_BOL_Service::getInstance()->getProperIcon(strtolower($fileNameExt));
        ...
        OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_BEFORE_GROUP_VIEW_RENDER, array(
