...
class IISNEWSFEEDPIN_MCLASS_EventHandler
{
    ...
    public function init()
    {
        ...
        /* Adding pin feature to newsfeed on creation is disabled due to decision made in 7/4/2018 on issue #5531*/
            /*$eventManager->bind(IISEventManager::ON_AFTER_UPDATE_STATUS_FORM_RENDERER, array($service, 'addPinButtonToNewsfeedMobile'));*/
