...
class NOTIFICATIONS_BOL_Service
{
    ...
    public function saveNotification( NOTIFICATIONS_BOL_Notification $notification )
    {
        ...
        OW::getEventManager()->trigger(new OW_Event(self::EVENT_AFTER_SAVE_NOTIFICATION));
    }
    ...
    public function markNotificationsViewedByIds( $idList, $viewed = true )
    {
        ...
        if(isset($notificationList[0])) {
            OW::getEventManager()->trigger(new OW_Event('notifications.after_items_viewed', array('userId' => $notificationList[0]->userId)));
        }
    }
