...
class NOTIFICATIONS_BOL_Notification extends OW_Entity
{
    ...
    {
        $homeUrlCorrectorEvent = OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_AFTER_NOTIFICATION_STRING_READ, array('data' => $this->data)));
        if(isset($homeUrlCorrectorEvent->getData()['data'])){
            return $homeUrlCorrectorEvent->getData()['data'];
        }
