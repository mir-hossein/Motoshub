 ...
 * Time: 11:04 AM
 */
class IISQUESTIONS_CTRL_Question extends OW_ActionController
{
    /**
     *
    ...
    public function question($params)
    {
        ...
        $cmp = new IISQUESTIONS_CMP_Question($question, OW::getUser()->getId(), $canUserEdit);
    ...
    public function reloadQuestion($params)
    {
        ...
        if (isset($_POST['newQuestion'])){
            $cmp = new IISQUESTIONS_CMP_Question(null, OW::getUser()->getId(), OW::getUser()->isAuthenticated(), $_POST['questionId'], $_POST['options']);
        }
        else{
            $question = $this->service->findQuestion($questionId);
    ...
    public function questionHome($param)
    {
        ...
        $menu = new IISQUESTIONS_CMP_ListMenu($type);
