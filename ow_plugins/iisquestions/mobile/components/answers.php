 ...
 * Time: 1:10 PM
 */
class IISQUESTIONS_MCMP_Answers extends OW_MobileComponent
{
    ...
    public function __construct( array $idList, $totalCount )
    {
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('iisquestions')->getMobileCmpViewDir() . 'answers.html');
    }
}