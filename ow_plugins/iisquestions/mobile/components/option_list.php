 ...
 * Time: 1:08 PM
 */
class IISQUESTIONS_MCMP_OptionList extends OW_MobileComponent
{
    private $editMode;
    /**
    ...
    public function __construct($question, array $optionList, $userId, $editMode = false)
    {
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('iisquestions')->getMobileCmpViewDir() . 'option_list.html');
    }
    ...
    public function onBeforeRender()
    {
        ...
        foreach ($this->optionList as $option) {
            $optionCmp = new IISQUESTIONS_MCMP_Option($option, $this->userId, $this->editMode || $option->userId == $this->userId, $isMultiple);
