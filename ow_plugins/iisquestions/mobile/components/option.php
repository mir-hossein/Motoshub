 ...
 * Time: 1:11 PM
 */
class IISQUESTIONS_MCMP_Option extends OW_MobileComponent
{
    ...
    public function __construct(IISQUESTIONS_BOL_Option $opt, $userId, $editMode = false, $multiple = true, $disabled = false)
    {
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('iisquestions')->getMobileCmpViewDir() . 'option.html');
    }
    ...
    public function onBeforeRender()
    {
        ...
        $avatarList = new IISQUESTIONS_MCMP_Answers($this->userIds, $this->answerCount);
